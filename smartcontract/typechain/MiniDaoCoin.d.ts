...
interface MiniDaoCoinInterface extends ethers.utils.Interface {
  functions: {
    ...
    "submitExpense(string,address,uint256,address,string)": FunctionFragment;
...
export class MiniDaoCoin extends Contract {
  ...
  interface: MiniDaoCoinInterface;
  ...
  functions: {
    ...
    "submitExpense(string,address,uint256,address,string)"(
      _description: string,
      _coinAddress: string,
      _amount: BigNumberish,
      _forAddress: string,
